...
function Header() {
	...
	return (
		<div
			className='text-pink-500 sticky top-0 p-5 bg-black shadow-sm z-50
        border-b-2 border-pink-700 max-w-7xl mx-auto'>
			<div
            ...
            lg:items-center'>
				...
				<div className='col-span-4 text-left lg:text-center'>
					...
					<h1 className='text-3xl'>Welcome to the KH METAVERSE</h1>
